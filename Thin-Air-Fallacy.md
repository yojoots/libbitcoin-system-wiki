...
The state has many sources of tax revenue, but typically central banks supports discount rates using seigniorage. Central banks are famous for proclaiming that they do not "print money", but this is exactly what they do. The U.S. Federal Reserve has the power to [order new money](https://www.newyorkfed.org/aboutthefed/fedpoint/fed01.html) from the Treasury. It pays the printing cost for "paper bills" and face value for [coinage](https://en.wikipedia.org/wiki/Coin). Typically coinage is produced such that it has higher face value than [use value](https://en.wikipedia.org/wiki/Use_value), in order to prevent [disappearance](https://en.wikipedia.org/wiki/Gresham%27s_law) of the coins.