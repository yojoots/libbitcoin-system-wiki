...
Pooling creates the Bitcoin analogy to the United States Federal Reserve system. The system was designed to facilitate tax through [debasement](https://en.wikipedia.org/wiki/Debasement). It offered a [state supported](https://en.wikipedia.org/wiki/Legal_tender) [monetary proxy](https://en.wikipedia.org/wiki/Federal_Reserve_Note) for actual money. This combination was designed to create a pooling pressure to collect actual money at the central authority. Once pooling was sufficient the state removed the pretense and [seized all remaining money](https://en.wikipedia.org/wiki/Executive_Order_6102).