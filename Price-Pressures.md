...
Bitcoin supply is independent of price, which reflects the effect of demand alone. Given that [subsidy](Glossary#subsidy) is predictable it is capitalized and therefore has [no affect on price](Inflation-Fallacy) over time. The purpose of the subsidy is to rationally distribute [units](Glossary#units) and is therefore eventually removed altogether.
