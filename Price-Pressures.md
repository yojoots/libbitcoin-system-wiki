The [exchange](Glossary#exchange) [price](Glossary#price) of a money is is determined by its [supply and demand](https://en.m.wikipedia.org/wiki/Supply_and_demand) which is in turn affected by the supply and demand schedules of all people for all products. 
...
Commodity and fiat monies exhibit rational and arbitrary supply increases respectively that mitigate the effect of rising demand on price, while Bitcoin does not. However as [fees](Glossary#fee) necessarily rise with demand the [utility threshold](Utility-Threshold-Property) mitigates it directly.
