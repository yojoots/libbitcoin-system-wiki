...
```
The bank's capital ratio does not *cause* its nominal interest rate, as that is determined on the [market](Glossary#market). But it is the expression of the individual bank's time preference. There is no distinction between accepting the market rate that satisfies time preference (the [traditional explanation](https://mises.org/library/man-economy-and-state-power-and-market/html/p/990)) and accepting *any* positive market rate for the fraction of money not preferred for liquidity.
