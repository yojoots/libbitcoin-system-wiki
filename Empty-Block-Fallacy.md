...
Given that the marginal cost of including transactions is necessarily below average fee levels, the empty block miner is suffering an opportunity cost. This amounts to the miner subsidizing the security of the [chain](Glossary#chain). While this is economically irrational in the limited context of the coin, it can of course be rational for a miner depending on circumstance. There is the case of no transactions to mine, and of opportunity cost for waiting on a new [candidate](Glossary#candidate) following an [announcement](Glossary#announcement).