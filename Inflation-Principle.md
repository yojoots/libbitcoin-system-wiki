...
This statement is based on the error of assuming that market money is price inflationary. It is therefore unproven by it. Money prices for a good rise due to increasing demand for that good. Yet the money relation pertains to *all goods* demanded in the money. As such, absent a change in the amount of goods, the increase in money exchange demand for one good implies a reduction in that for others. This truth is explicitly recognized by the money relation itself, on which the statement relies.
...
The ability to obtain goods with a money is a reflected by the level to which the money is accepted in trade. If not accepted in [exchange](Glossary#exchange) for goods, a thing has no monetary value. A money only exhibits monetary value in its ability be exchanged for things with [use value](https://en.m.wikipedia.org/wiki/Use_value).