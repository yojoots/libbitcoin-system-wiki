...
The ability to obtain goods with a money is a reflected by the level to which the money is accepted in trade. A money exhibits monetary value only in its ability be [exchanged](Glossary#exchange) for things with [use value](https://en.m.wikipedia.org/wiki/Use_value).