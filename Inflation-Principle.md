...
The ability to obtain goods with a money is a reflected by the level to which the money is accepted in trade. If not accepted in [exchange](Glossary#exchange) for goods, a thing has no monetary value. A money is useful only in its ability be exchanged for goods.